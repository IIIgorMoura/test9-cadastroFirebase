...
export default function App() {
  ...
  // se o user for autenticado, ele busca as mensagens do usuario
  useEffect(() => {
    if (usuario) {
      // buscarMensagens();
    } else {
  ...
  //   try {
  //     if (usuario) {
  //       // aq ele requisita a coleção messages do firestore, procurando no uid = ao respectivo do usuario
